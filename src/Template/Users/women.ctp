        ...
        <div class="row">
            <div class="col-md-12">
                <div class="men-banner-text">
                    <h2><a href="<?= HTTP_ROOT; ?>women" style="color: #ff6c00;">STYLE FIT FOR WOMEN</a></h2>
            ...
            <div class="col-md-6">
                <div class="mens-fit-text">
                    ...
                    <ul>
                        ...
                        <li>
                            We carry Women’s size <a href="<?= HTTP_ROOT; ?>women/plus-size">See our full women's sizes »</a>
                        </li>
