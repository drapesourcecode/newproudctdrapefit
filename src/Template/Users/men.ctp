        ...
        <div class="row">
            <div class="col-md-12">
                <div class="men-banner-text">
                    <h2><a href="<?= HTTP_ROOT; ?>men" style="color: #ff6c00;">STYLE FIT FOR MEN</a></h2>
            ...
            <div class="col-md-6">
                <div class="mens-fit-text">
                    ...
                    <ul>
                        ...
                        <li>
                            We carry Men’s size <a href="<?= HTTP_ROOT; ?>help-center/find-your-size">See our full men's sizes »</a>
                        </li>
