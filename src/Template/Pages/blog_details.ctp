...
<style>    
    ...
    .form-control,.navbar a,.overlay:before,a {
    ...
    .d-table,.height-100,body,html {
        height: 100%
    }

    .overlay:before,.rt-btn2::after,.rt-btn:after,.rt-btn:before {
        content: ""
    }

    .scale-toggle,.search-box button,a,a>* {
        cursor: pointer
    }
    ...
    .custom-tab .nav-tabs>li>a,.social-link a,
    .video-btn>h5 {
        font-family: Poppins, sans-serif
    }
    ...
    .bg-img-2 {
        background-image: url(<?php echo HTTP_ROOT; ?>img/blog/2.png);
    ...
    .overlay.dark-1:before {
        background-color: rgba(3, 13, 39, .9)
    }
    ...
    .overlay.dark-3:before {
        background-color: rgba(3, 13, 39, .8)
    }
    ...
    .overlay.dark-5:before {
        background-color: rgba(3, 13, 39, .2)
    }

    .overlay.dark-6:before {
        background-color: rgba(3, 13, 39, .6)
    }
    ...
    .overlay-1:before {
        background-color: rgba(255, 33, 89, .9)
    }
    ...
    .overlay-3:before {
        background-color: rgba(9, 212, 222, .9)
    }

    .overlay-4:before {
        background-color: rgba(9, 212, 222, .8)
    }
    ...
    .mainmenu .sub-menu {
        ...
        padding: 35px 0;
        opacity: 0;
        -webkit-box-shadow: 0 0 15px 0 rgba(30, 28, 28, .1);
        box-shadow: 0 0 15px 0 rgba(30, 28, 28, .1)
    }
    ...
    #active-sticky.is-sticky {
        ...
        width: 100%;
        z-index: 999;
        -webkit-box-shadow: 0 1px 4px rgba(2, 3, 3, .15);
    ...
    .circle-wrap .circle {
        -webkit-animation: 4s cubic-bezier(.36, .11, .89, .32) 0s normal none infinite running scaleIn;
        animation: 4s cubic-bezier(.36, .11, .89, .32) 0s normal none infinite running scaleIn;
    ...
    .single-service {
        border-radius: 10px;
        -webkit-box-shadow: 0 5px 10px 0 rgba(33, 29, 30, .15);
        box-shadow: 0 5px 10px 0 rgba(33, 29, 30, .15);
        -webkit-transform: perspective(1px) translateZ(0);
        transform: perspective(1px) translateZ(0)
    }
    ...
    .blog-post.without-thumb {
        -webkit-box-shadow: 0 0 1px rgba(30, 27, 28, .5) inset;
        box-shadow: 0 0 1px rgba(30, 27, 28, .5) inset;
        padding: 45px 27px 35px 35px
    }

    .blog-post.on-bg .content {
        background-color: rgba(3, 13, 39, .85);
        height: 100%;
        left: 0;
    ...
    .image-blog .blog-post .overlay:after {
        ...
        width: 100%;
        height: 100%;
        background: -webkit-gradient(linear, left top, left bottom, from(rgba(255, 255, 255, .8)), to(transparent));
        background: -webkit-linear-gradient(rgba(255, 255, 255, .8), transparent);
        background: -o-linear-gradient(rgba(255, 255, 255, .8), transparent);
    ...
    .image-blog .blog-post .overlay:after {
        ...
        opacity: 1;
        background: -webkit-gradient(linear, left top, left bottom, from(transparent), to(rgba(3, 13, 39, .8)));
        background: -webkit-linear-gradient(transparent, rgba(3, 13, 39, .8));
        background: -o-linear-gradient(transparent, rgba(3, 13, 39, .8));
        background: linear-gradient(transparent, rgba(3, 13, 39, .8))
    }
    ...
    .image-blog .blog-post .overlay::before {
        ...
        -o-transition: all .5s ease 0s;
        transition: all .5s ease 0s;
        background: -webkit-gradient(linear, left top, left bottom, from(transparent), to(rgba(255, 33, 79, .8)));
        background: -webkit-linear-gradient(transparent, rgba(255, 33, 79, .8));
        background: -o-linear-gradient(transparent, rgba(255, 33, 79, .8));
        background: linear-gradient(transparent, rgba(255, 33, 79, .8))
    }
    ...
    @-webkit-keyframes red-shadow {
        0% {
            -webkit-box-shadow: 0 0 0 0 rgba(255, 33, 79, .4);
    ...
    @-webkit-keyframes blue-shadow {
        0% {
            -webkit-box-shadow: 0 0 0 0 rgba(65, 34, 142, .4);
            box-shadow: 0 0 0 0 rgba(65, 34, 142, .4)
        }
        100% {
            -webkit-box-shadow: 0 0 0 30px transparent;
            box-shadow: 0 0 0 30px transparent
...
/*.comment-list li.reply.reply2 {
    margin-left: 250px;
}*/
.single-post.pb-80 h1 span{
    color: #fe6c00 !important;
}
.footer-social ul li a {
    padding: 5px 2px;
}
.comment-box .custom-input input, .comment-box .custom-input textarea {
...
.menu-bar.menu-list label p img{
        margin-top: -5px;
}
.section-padding {
    padding: 20px 0;
...
<section class="page-sections blog-sectio">
    ...
    <div class="bannerwidth">
        <div class="row">
            <div class="col-sm-12 col-lg-12 col-md-12">
                ...
                <li><b>></b></li>
                <li><a href="https://www.drapefit.com/style-blog/">BLOG</a></li>
                <li><b>></b></li>
                <li>Blog Details</li>
                </ul>
                <h2>Blog Details</h2>
...
<div class="blog-details white-bg section-padding" style="float: left;width: 100%;padding: 49px 0 38px;">
    <div class="container">
        <div class="row">
           <?= $this->Flash->render() ?>
            <div class="col-xs-12 col-sm-8 mobi-mb-50">
                <div class="single-post pb-80">
                    <?php /* ?><div class="thumb fix mb-50">
                        <img src="<?php echo HTTP_ROOT. BLOGIMG . $blogDetails->blog_image; ?>" alt="<?php echo $blogDetails->blog_title; ?>" />
                    </div><?php */ ?>
                    <div class="content">
                        <?php echo $blogDetails->blog_description ; ?>
                        
                        <?php /* ?><h5 class="theme-color mb-10"><?php echo date('d F,y', strtotime($blogDetails->created)); ?></h5>
                        ...
                        <div class="rating-box">
                            <h5>Rating</h5>
                            <?php  $blograting = $this->Custom->blograting($blogDetails->id); ?>
                            <fieldset class="rating">
                                <input <?php if($blograting ==5 || $blograting>4.5){ ?> checked="checked"<?php } ?> type="radio" id="star5" name="rating" value="5" />
                                <label class = "full" for="star5" title="Awesome - 5 stars"></label>
                                <input <?php if($blograting ==4.5 || ($blograting>4 && $blograting<4.5)){ ?> checked="checked"<?php } ?> type="radio" id="star4half" name="rating" value="4.5" />
                                <label class="half" for="star4half" title="Pretty good - 4.5 stars"></label>
                                <input <?php if($blograting == 4 || ($blograting>3.5 && $blograting<4)){ ?> checked="checked" <?php } ?> type="radio" id="star4" name="rating" value="4" />
                                <label class = "full" for="star4" title="Pretty good - 4 stars"></label>
                                <input <?php if($blograting ==3.5 || ($blograting>3 && $blograting<3.5)){ ?> checked="checked"<?php } ?> type="radio" id="star3half" name="rating" value="3.5" />
                                <label class="half" for="star3half" title="Meh - 3.5 stars"></label>
                                <input <?php if($blograting ==3 || ($blograting>2.5 && $blograting<3)){ ?> checked="checked"<?php } ?> type="radio" id="star3" name="rating" value="3" />
                                <label class = "full" for="star3" title="Meh - 3 stars"></label>
                                <input <?php if($blograting ==2.5 || ($blograting>2 && $blograting<2.5)){ ?> checked="checked"<?php } ?> type="radio" id="star2half" name="rating" value="2.5" />
                                <label class="half" for="star2half" title="Kinda bad - 2.5 stars"></label>
                                <input <?php if($blograting ==2 || ($blograting>4 && $blograting<2)){ ?> checked="checked"<?php } ?> type="radio" id="star2" name="rating" value="2" />
                                <label class = "full" for="star2" title="Kinda bad - 2 stars"></label>
                                <input <?php if($avarating ==1.5 || ($blograting>1 && $blograting<1.5)){ ?> checked="checked"<?php } ?> type="radio" id="star1half" name="rating" value="1.5" />
                                <label class="half" for="star1half" title="Meh - 1.5 stars"></label>
                                <input <?php if($blograting ==1 || ($blograting>0.5 && $blograting<1)){ ?> checked="checked"<?php } ?> type="radio" id="star1" name="rating" value="1" />
                                <label class = "full" for="star1" title="Sucks big time - 1 star"></label>
                                <input <?php if($blograting ==0.5 || ($blograting>0.5 && $blograting<0.5)){ ?> checked="checked"<?php } ?> type="radio" id="starhalf" name="rating" value="0.5" />
                                <label class="half" for="starhalf" title="Sucks big time - 0.5 stars"></label>
                            </fieldset>
                        </div>

                        <div class="tag-share clearfix pt-65">
                            <div class="pull-left">
                                <strong>Tags:</strong> <a href="#">Design,</a> <a href="#">Development,</a><a href="#">Nice,</a><a href="#">Creative</a>
                            </div>
                        ...
                        <div class="divider pt-20">
                            <hr class="line"/>
                        </div>
                    </div>
                </div>
                <!-- Post Details End -->
                <div class="admin-box mb-75 fix">
                    <div class="admin-img pull-left mr-30">
                        <?php if($blogDetails->auther_image == ''){ ?>
                            <img src="<?php echo HTTP_ROOT. BLOGIMG . 'no_img.png' ?>" alt="<?php echo $blogDetails->auther_name; ?>"/>
                        <?php } else{?>
                            <img src="<?php echo HTTP_ROOT. BLOGIMG . $blogDetails->auther_image; ?>" alt="<?php echo $blogDetails->auther_name; ?>"/>
                        <?php } ?>
                    </div>
                    <div class="text">
                        <h6>Written By</h6>
                        <h3 class="mb-10"><?php echo $blogDetails->auther_name; ?></h3>
                        <p><?php echo $blogDetails->auther_descriptions; ?></p>
                    </div>
                </div>
                <!-- Admin Comment Box End -->
                <div class="comment-area">
                    <div class="title mb-40">
                        <h4 class="mb-10">Comments: <?php echo $comntcount ;?></h4>
                        <hr class="line"/>
                    </div>
                    <div class="comment-list mb-75">
                        <ul>
                            <?php foreach($blogComments as $Comments){ ?>
                            <li>
                                <div class="reply-coment-box">
                                <div class="commenter-img pull-left mr-30">
                                    <?php if($Comments->image == ''){ ?>
                                         <img src="<?php echo HTTP_ROOT. BLOGIMG . 'no_img.png' ?>" alt="<?php echo $Comments->full_name; ?>" />
                                    <?php } else{ ?>
                                        <img src="<?php echo HTTP_ROOT. BLOGIMG . $Comments->image; ?>" alt="<?php echo $Comments->full_name; ?>" />
                                    <?php } ?>
                                </div>
                                <div class="text">
                                    <div class="reply-btn pull-right">
                                        <a id="Mybtn<?php echo $Comments->id ?>">Reply</a>
                                    </div>
                                    <h3 class="mb-10"><?php echo $Comments->full_name; ?></h3>
                                    <p><?php echo $Comments->comments; ?></p>
                                </div>
                                </div>
                                <div id="MyForm<?php echo $Comments->id ?>" class="cntform" style="display:none">
                                <?= $this->Form->create('', array('class'=> 'custom-input','id' => 'reply_form', 'data-toggle' => "validator", 'type' => 'file')) ?>
                                <div class="row">
                                    <div class="col-xs-12 col-md-6">
                                        <input type="text" name="reply_fullname" id="reply_fullname" placeholder="Your Name" />
                                    </div>
                                    <div class="col-xs-12 col-md-6">
                                        <input type="email" name="reply_email" id="reply_email" placeholder="Enter Your Email" />
                                    </div>
                                </div>
                                <script>
                                    $('#Mybtn<?php echo $Comments->id; ?>').click(function(){
                                        $('#MyForm<?php echo $Comments->id; ?>').toggle(500);
                                    });
                                </script>
                                <input type="hidden" value="<?php echo $Comments->id; ?>" name="comment_id" id="comment_id" class="comment_id">
                                <input type="file" name="reply_image" id="reply_image">
                                <textarea name="reply_comments" id="reply_comments" rows="3" placeholder="Comment"></textarea>
                                <button class="btn rt-btn2" type="submit" name="submit">Post Comment</button>
                                <?php echo $this->Form->end(); ?>
                            </div>
                            </li>
                            
                            <?php 
                            $commentReply = $this->Custom->comntReply($Comments->id);
                            foreach($commentReply as $comnttReply){ ?>
                                <li class="reply">
                                    <div class="reply-coment-box">
                                    <div class="commenter-img pull-left mr-30">
                                        <?php if($comnttReply->reply_image == ''){ ?>
                                             <img src="<?php echo HTTP_ROOT. BLOGIMG . 'no_img.png' ?>" alt="<?php echo $comnttReply->reply_fullname; ?>" />
                                        <?php } else{ ?>
                                            <img src="<?php echo HTTP_ROOT. BLOGIMG . $comnttReply->reply_image; ?>" alt="<?php echo $comnttReply->reply_fullname; ?>" />
                                        <?php } ?>
                                    </div>
                                    <div class="text">
                                        <div class="reply-btn pull-right">
                                            <a id="Mybtnsc<?php echo $comnttReply->id ?>">Reply</a>
                                        </div>
                                        <h3 class="mb-10"><?php echo $comnttReply->reply_fullname; ?> <?php echo $Comments->full_name; ?></h3>
                                        <p><?php echo $comnttReply->reply_comments; ?></p>
                                    </div>
                                    </div>
                                    <div id="MyFormsc<?php echo $comnttReply->id ?>" class="cntform" style="display:none">
                                    <?= $this->Form->create('', array('class'=> 'custom-input','id' => 'secndreply_form', 'data-toggle' => "validator", 'type' => 'file')) ?>
                                    <div class="row">
                                        <div class="col-xs-12 col-md-6">
                                            <input type="text" name="scndreply_fullname" id="scndreply_fullname" placeholder="Your Name" />
                                        </div>
                                        <div class="col-xs-12 col-md-6">
                                            <input type="email" name="scndreply_email" id="scndreply_email" placeholder="Enter Your Email" />
                                        </div>
                                    </div>
                                    <script>
                                        $('#Mybtnsc<?php echo $comnttReply->id; ?>').click(function(){
                                            $('#MyFormsc<?php echo $comnttReply->id; ?>').toggle(500);
                                        });
                                    </script>
                                    <input type="hidden" value="<?php echo $comnttReply->id; ?>" name="reply_id" id="reply_id" class="reply_id">
                                    <input type="file" name="scndreply_image" id="scndreply_image">
                                    <textarea name="scndreply_comments" id="scndreply_comments" rows="3" placeholder="Comment"></textarea>
                                    <button class="btn rt-btn2" type="submit" name="submit">Post Comment</button>
                                    <?php echo $this->Form->end(); ?>
                                </div>
                                </li>
                                    ...
                                    <?php 
                                        $commentscReply = $this->Custom->comntscReply($comnttReply->id); 
                                        foreach($commentscReply as $comnttscReply){   
                                    ?>
                                        <li class="reply reply2">
                                            <div class="commenter-img pull-left mr-30">
                                                <?php if($comnttscReply->scndreply_image == ''){ ?>
                                                     <img src="<?php echo HTTP_ROOT. BLOGIMG . 'no_img.png' ?>" alt="<?php echo $comnttscReply->reply_fullname; ?>" />
                                                <?php } else{ ?>
                                                    <img src="<?php echo HTTP_ROOT. BLOGIMG . $comnttscReply->scndreply_image; ?>" alt="<?php echo $comnttscReply->reply_fullname; ?>" />
                                                <?php } ?>
                                            </div>
                                            <div class="text">
                                                <!--<div class="reply-btn pull-right">
                                                    <a id="Mybtnsc">Reply</a>
                                                </div>-->
                                                <h3 class="mb-10"><?php echo $comnttscReply->scndreply_fullname; ?> <?php echo $comnttReply->reply_fullname; ?></h3>
                                                <p><?php echo $comnttscReply->scndreply_comments; ?></p>
                                            </div>
                                        </li>
                                    <?php } ?>
                                <?php } ?>
                    ...
                    <div class="comment-box">
                        ...
                        <?= $this->Form->create('', array('class'=> 'custom-input','id' => 'profile_data', 'data-toggle' => "validator", 'type' => 'file')) ?>
                            <div class="row">
                                <div class="col-xs-12 col-md-6">
                            ...
                            <input type="hidden" value="<?php echo $blogDetails->id; ?>" name="blog_id" id="blog_id">
                            <input type="file" name="image" id="image">
                            <textarea name="comments" id="comments" rows="3" placeholder="Comment"></textarea>
                            <button class="btn rt-btn2" type="submit" name="submit">Post Comment</button>
                        <?php echo $this->Form->end(); ?>
                    </div>
                </div>
            ...
            <div class="col-xs-12 col-sm-4">
                <div class="sidebar pl-50">
                    <div class="widget gray-bg mb-30">
                    ...
                    <!-- <div class="widget gray-bg mb-30">
                        ...
                        <div class="about">
                            <img src="<?php echo HTTP_ROOT; ?>img/blog/sidebar/about.jpg" alt="Thumbnail" />
                            <p>If you are going to use a passage of Lorem you need to be surthere isn't anything embarrassi hidden in the middle of text.</p>
                        </div>
                    </div> -->
                    <!-- Widget End -->
                    <!-- <div class="widget gray-bg mb-30">
                        ...
                        <div class="category">
                            <ul>
                                <li><a href="#">Winter <span>(10)</span></a></li>
                                <li><a href="#">Fall <span>(0)</span></a></li>
                                <li><a href="#">Maternity Style <span>(0)</span></a></li>
                                <li><a href="#">Kids Summer <span>(0)</span></a></li>
                                <li><a href="#">Men’s Summer <span>(0)</span></a></li>
                                <li><a href="#">UI/UX Design <span>(30)</span></a></li>
                                <li><a href="#">WordPress <span>(14)</span></a></li>
                            </ul>
                        </div>
                    </div> -->
                    <!-- Widget End -->
                            ...
                            <ul>
                                <li>
                                    <div class="thumb pull-left">
                                        <img src="<?php echo HTTP_ROOT; ?>img/blog/sidebar/1.jpg" alt="Thumbnail" />
                                    </div>
                                    <div class="desc pl-15">
                                        <h6 class="theme-color">18 September 2019</h6>
                                        <a href="<?php echo HTTP_ROOT; ?>blog-details"><p>
                                                Predefined chunks As the first true generato.
                                            </p></a>
                                    </div>
                                </li>
                                <li>
                                    <div class="thumb pull-left">
                                        <img src="<?php echo HTTP_ROOT; ?>img/blog/sidebar/2.jpg" alt="Thumbnail" />
                                    </div>
                                    <div class="desc pl-15">
                                        <h6 class="theme-color">10 September 2019</h6>
                                        <a href="<?php echo HTTP_ROOT; ?>blog-details"><p>
                                                Are going to use pass age of Lorem Ipsum.
                                            </p></a>
                                    </div>
                                </li>
                                <li>
                                    <div class="thumb pull-left">
                                        <img src="<?php echo HTTP_ROOT; ?>img/blog/sidebar/3.jpg" alt="Thumbnail" />
                                    </div>
                                    <div class="desc pl-15">
                                        <h6 class="theme-color">18 September 2019</h6>
                                        <a href="<?php echo HTTP_ROOT; ?>blog-details"><p>
                                                On the Internet. It uses diction of over.
                                            </p></a>
                                    </div>
                                </li>
                            </ul>
...
<script>
    $(function(){
        ...
        $("#reply_form").validate({
            rules:{
                reply_fullname:"required",
                reply_email:{
                    required:true,
                    email:true,
                },
                reply_comments : "required",
            },
            messages:{
                reply_fullname:"Please enter your name",
                reply_email:{
                    required:"Please enter your email address",
                    reply_email:"Please enter your valid email address",
                },
                reply_comments:"Please leave a comment",
            },
        });
        $("#secndreply_form").validate({
            rules:{
                scndreply_fullname:"required",
                scndreply_email:{
                    required:true,
                    email:true,
                },
                scndreply_comments : "required",
            },
            messages:{
                scndreply_fullname:"Please enter your name",
                scndreply_email:{
                    required:"Please enter your email address",
                    scndreply_email:"Please enter your valid email address",
                },
                scndreply_comments:"Please leave a comment",
            },
        });
