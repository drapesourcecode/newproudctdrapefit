...
.three-person ul li a:hover,.three-person ul li a.active{
    color: #ef7600;
}
.three-person ul li a:hover:after,.three-person ul li a.active:after
{
    height: 2px;
    background: #ef7600;
    content: "";
...
<div class="blog-area list-blog white-bg section-padding" style="">
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12 col-lg-12 col-md-12">
                <ul>
                    <li><a class="active" href="#"><i class="fa fa-male"></i> Men</a></li>
