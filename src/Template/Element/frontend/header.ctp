...
<?php } else { ?>
                        <ul id="menu">
                            <li>
                                <a <?php if ($action == "men" || $action == "bigTall" || $action == "styleGuide") { ?>class="active" <?php } ?> href="<?= HTTP_ROOT; ?>men">
                                    <i class="fa fa-male"></i>
                                    <span>Men</span>
                                </a>                  
                            </li>
                            <li>
                                <a <?php if ($action == "women" || $action == "plusSize" || $action == "maternity" || $action == "petite" || $action == "womenJeans" || $action == "womenBusiness") { ?>class="active" <?php } ?>  href="<?= HTTP_ROOT; ?>women">
