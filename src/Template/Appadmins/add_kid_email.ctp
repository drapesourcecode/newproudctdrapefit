...
<div class="content-wrapper">
 ...
 <div class="col-xs-12">
      ...
      <div class="col-xs-12">
       <div class="form-group">
        <label for="exampleInputName">Email Body</label>
        ...
        <?= $this->Form->input('kid_id', ['value' => $paymentDetails->kid_id,'type' => 'hidden', 'label' => false, 'kl_virtual_keyboard_secure_input' => "on"]); ?>
