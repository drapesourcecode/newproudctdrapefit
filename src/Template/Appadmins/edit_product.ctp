                                            ...
                                            <div class="col-md-6">
                                                <?php if (@$product->product_image) { ?>
                                                    <div class="col-md-8">
                                                        ...
                                                        <p><a onclick="return confirm('Are you sure want to delete ?')" href="<?php echo HTTP_ROOT . 'appadmins/productimagedelete/' . @$product->id ?>"><img src="<?php echo HTTP_ROOT . 'img/trash.png' ?>"/></a></p>
                                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                <?php if (@$product->product_receipt) { ?>
                                                    <div class="col-md-8">
                                                        ...
                                                        <p><a onclick="return confirm('Are you sure want to delete ?')" href="<?php echo HTTP_ROOT . 'appadmins/productreceiptdelete/' . @$product->id ?>"><img src="<?php echo HTTP_ROOT . 'img/trash.png' ?>"/></a></p>
                                                    </div>
