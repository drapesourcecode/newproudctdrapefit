        ...
        <div class="cat-log">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="first-three" style="float: left; width: 49%; padding: 0 12px; box-sizing: border-box;">
                        <div class="cat-log-smallbox"> 
                    ...
                    <div class="suge" style="float: left; width: 100%;">
