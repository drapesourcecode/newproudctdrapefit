                            ...
                            <tbody>
                                <?php foreach ($AllUserList as $aduserlist): ?>
                                    ...
                                    <td style="text-align: center;">
                                        ...
                                        <?php } ?>
                                        <?= $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-trash')), ['action' => 'listCustomerDetails', $aduserlist->id], ['escape' => false, "data-placement" => "top", "data-hint" => "Delete", 'class' => 'btn btn-danger hint--top  hint', 'style' => 'padding: 0 7px!important;', 'confirm' => __('Are you sure you want to delete Admin ?')]); ?>
