        ...
        <div class="row">
            ...
            if ($usersDetailsCount >= 1) {
                foreach (@$usersDetails as $detail) {
                    ...
                    <div class="col-md-3" id="colmd-<?php echo $detail->id; ?>" style="display: block;">
                        <!-- DIRECT CHAT PRIMARY -->
                            ...
                            <div class="emo-popup" id="main-emo-popup" style="display: none;">
                                <ul class="emo-area">
                                    <?php foreach ($getEmoticons as $getEmoticon) { ?>
                                        <li><a href="javascript:;" onclick="insertEmoctions('<?php echo $getEmoticon->shortcut; ?>', 'msg-<?php echo  $detail->id; ?>')" id="smile" ><img id="insert_smile"  src="<?php echo $getEmoticon->image_url ?>" title=":<?php echo $getEmoticon->shortcut; ?>"/></a></li>
                                    <?php } ?>
                                </ul>
                            </div>
            ...
            <?php } else { ?>
                <div class="col-md-3">
                    Yet you have no customers
                    <?php
                    $page = HTTP_ROOT . 'appadmins/direct_chat/';
                    $sec = "10";
